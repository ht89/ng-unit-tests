...
describe('AppComponent', () => {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            ...
            /* 
                can also use 'fixture.nativeElement' although debugElement is more platform-agnostic since the tests may be run on a non-browser platform or whose DOM emulation does not support the full HTMLElement API & has more methods & properties
            */
