...
describe('WelcomeComponent', () => {
    ...
    // it should be mocked to avoid problems e.g. the APIs ask user to login, the test freezes due to a long wait
    ...
    beforeEach(async(() => {
        // TestBed is a root injector
        // overrideComponent is a component injector
    ...
    beforeEach(() => {
        ...
        el = de.query(By.css('.welcome')).nativeElement;
        ...
        userService = de.injector.get(UserService); // component injector

        /* 
            root injector but not as safe as the component injector
            demo by removing UserService in app module and inject it into welcome component
            and enable overrideComponent above
        */
